...
export default function Contact() {
  ...
  return (
    ...
    >
      <SectionHeading width={200}>Contact me</SectionHeading>
      <div className=" flex flex-col justify-center items-center mt-12">
        <p className="my-2 text-black dark:text-white">
          Gmail:{" "}
          <span className=" underline hover:scale-105 hover:text-blue-500">
            goramanilnayak@gmail.com
          </span>
        </p>
        <p className="my-2 text-black dark:text-white mb-16">
          Modile:{" "}
          <span className=" underline hover:scale-105 hover:text-blue-500">
            +91 7989278697
          </span>
