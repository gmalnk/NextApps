...
export const stocksDict: StocksDict = {
  474: "3MINDIA",
  2595: "3PLAND",
  445: "5PAISA",
  11868: "63MOONS",
...
export default function StockBar() {
  return (
    <div className=" flex justify-between items-center bg-white h-12 w-full mb-1 py-2 px-2 rounded-bl-md">
      <div className="flex justify-center items-center h-full">
        ...
        <Separator
          ...
          className="h-full w-[1px] mx-2 bg-gray-300"
        />
        <TimeFrames />
        <Separator
          orientation="vertical"
      ...
      <div className="flex justify-center items-center gap-8">
        <div className="flex items-center justify-center gap-2 mx-1 relative right-0">
